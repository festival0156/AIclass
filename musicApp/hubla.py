...
def play_song():
    ...
    try:
        ...
        volume_label.config(fg="purple", text="Volume : "+str(current_volume))
...
#Labels
Label(master,text="Hubla Music Player",font=("Calibri",15),fg="red").grid(sticky="N",row=0,padx=120)
Label(master,text="Select File",font=("Calibri",12),fg="blue").grid(sticky="N",row=1)
Label(master,text="Volume",font=("Calibri",12),fg="green").grid(sticky="N",row=4)
